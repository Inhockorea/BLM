...
const slides = [
  { id: 0, text: 'Our lives begin to end the day, we become silent about things that matter.', duration: 0 },
  { id: 1, text: 'In the End, we will remember not the words of our enemies, but the silence of our friends.', duration: "3s"},
...
function Deck() {
  ...
  useEffect(() => void setInterval(() => setIndex(index => (index + 1) % 3), 5000), [])
